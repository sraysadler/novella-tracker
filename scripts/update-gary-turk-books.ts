...
const newBooks = [
  ...
  // @lucaskoakeley attribution update for existing book
  {
    id: 83,
    notes:
      "A crow moves into the home of a grieving father and his two sons. Part prose, part poetry, part fable. Strange, raw, and unlike anything else on this list. (via @lucaskoakeley on Instagram)",
  },
  ...
  // @lucaskoakeley books
  {
    ...
    pages: 171,
    notes:
      "The gods Hermes and Apollo bet on whether human consciousness would make animals happy or miserable. Fifteen dogs get to find out. A Giller Prize winner that's funnier and stranger than it has any right to be. (via @lucaskoakeley on Instagram)",
    film_adaptation: null,
    section_type: null,
    section_name: null,
    section_order: null,
  ...
  },
  {
    ...
    pages: 280,
    notes:
      '* An aging Sicilian prince watches his world dissolve during the Risorgimento. The source of the famous line: "If we want things to stay as they are, things will have to change." A cornerstone of Italian literature. (via @lucaskoakeley on Instagram)',
    film_adaptation: "1963 film directed by Luchino Visconti, starring Burt Lancaster.",
    section_type: null,
    section_name: null,
    section_order: null,
    section_subtitle: null,
  ...
  },
  {
    ...
    pages: 192,
    notes:
      "Ten chapters, each from the perspective of a different woman who loved Mr. Nishino. A portrait of a man assembled entirely from the women he left behind. (via @lucaskoakeley on Instagram)",
    film_adaptation: null,
    section_type: null,
    section_name: null,
    section_order: null,
  ...
  },
  {
    ...
    pages: 136,
    notes:
      "A miller's son is in love with a landowner's daughter. A short, lyrical tragedy about class, longing, and the cruelty of circumstance — from the Nobel laureate. (via @lucaskoakeley on Instagram)",
    film_adaptation: null,
    section_type: null,
    section_name: null,
    section_order: null,
